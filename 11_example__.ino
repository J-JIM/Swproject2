...
#define _DUTY_NEU 3200// servo neutral position (90 degree)
#define _DUTY_MAX 6000 // servo full counter-clockwise position (180 degree)
...
void loop() {
  ...
  if(dist_ema < _TARGET_LOW){
    ...
    int angle = map(dist_ema,_TARGET_LOW - 6.0,_TARGET_HIGH + 58.0,_DUTY_MIN, _DUTY_MAX);
