...
#define _INTERVAL_SERIAL  25 // serial interval (unit: ms)
...
#define _DUTY_MAX 2330 // 2000
#define _DUTY_NEU 1550 // 1500
#define _DUTY_MIN 500 // 1000

#define _SERVO_ANGLE_DIFF  18  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 698 + (-2.5*a_value) + (2.24E-03*a_value*a_value);
}
